...
import { $ as $$MarkdownPostLayout } from '../../chunks/MarkdownPostLayout_C5W5AwqR.mjs';
  ...
  return jsx("div", {
    children: jsxs("div", {
      ...
      children: [jsx("img", {
        ...
        class: "absolute bottom-10 xl:bottom-20 left-4 right-4 lg:left-0 lg:right-0 flex flex-col flex-start gap-2 overflow-hidden max-w-4xl mx-auto",
        children: [jsxs("div", {
          ...
          class: "max-w-2xs md:max-w-[720px] lg:max-w-4xl mx-auto flex gap-2 items-end overflow-x-auto no-scrollbar",
