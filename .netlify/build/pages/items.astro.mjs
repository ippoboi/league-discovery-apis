...
const $$ItemsCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(`/items/${data.id}`, "href")} class="relative overflow-hidden rounded-lg border border-zinc-900"> ${renderComponent($$result, "Image", $$Image, { "src": imageUrl, "alt": data.name + " splash art", "height": 1e3, "width": 1e3, "class": "lg:hover:scale-105 lg:transition-all lg:duration-300 lg:grayscale-75 lg:hover:grayscale-0" })} </a>`;
